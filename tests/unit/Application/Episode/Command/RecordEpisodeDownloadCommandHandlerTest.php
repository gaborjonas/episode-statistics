...
namespace App\Tests\unit\Application\Episode\Command;

use App\Application\Episode\Command\RecordEpisodeDownloadCommand\RecordEpisodeDownloadCommand;
use App\Application\Episode\Command\RecordEpisodeDownloadCommand\RecordEpisodeDownloadCommandHandler;
...
final class RecordEpisodeDownloadCommandHandlerTest extends TestCase
{
    ...
    private RecordEpisodeDownloadCommandHandler $handler;

    protected function setUp(): void
    {
        $this->repository = $this->createMock(IncomingEventRepositoryInterface::class);
        $this->eventBus   = $this->createMock(EventBusInterface::class);
        $this->handler    = new RecordEpisodeDownloadCommandHandler($this->repository, $this->eventBus);
    }
    ...
    private function makeCommand(): RecordEpisodeDownloadCommand
    {
        return new RecordEpisodeDownloadCommand(
