...
{
    private EpisodeDownloadRepositoryInterface&MockObject $repository;
    private EpisodeDownloadProjector $projector;

    protected function setUp(): void
    {
        $this->repository = $this->createMock(EpisodeDownloadRepositoryInterface::class);
        $this->projector  = new EpisodeDownloadProjector($this->repository);
    }

    #[Test]
    public function saves_episode_download_on_event(): void
    {
